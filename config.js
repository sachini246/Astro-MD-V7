...
ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://ibb.co/fYGcXwf' : process.env.ALIVE_LOGO,
FOOTER: process.env.FOOTER === undefined ? 'ᴀꜱᴛʀᴏ-ᴍᴅ ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴀʀᴀᴛᴇᴅ ʙʏ ᴛɴᴍ-ᴍᴅ*' : process.env.CAPTION,
